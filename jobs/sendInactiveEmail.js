                  ...
                  <table><td style="font-family:Calibri,Arial,sans-serif;font-size:14px;color:white">
                    ...
                    <a href="mailto:#" style="color:#FFFFFF;text-decoration:none" target="_blank">helpdesk@womenforwomen.org</a></p></td>
                            ...
                            <tr>
                               ...
                               <p>This is an automated email to let you know that we have inactivated the account for [[EMPLOYEE FULL NAME]] as instructed on the employee record in BambooHR.</p>
                               <p>Plesae, complete the following form for proper processing of this account.</p><p><a href="https://help.womenforwomen.org/portal/4/create/64" style="font-weight:bold;color:#66CDAA;text-decoration:none">USER TERMINATION FORM</a></p>
