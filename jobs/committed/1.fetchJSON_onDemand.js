fn(state => {
  return list('/')(state).then(state => {
    const partialFilenames = [
      ...
      // 'wfwi Donors 20231019',
      'wfwi Card Master 20231019',
      'wfwi Direct Debits 20231019',
      'wfwi Transactions - Cards 20231019',
      'wfwi Transactions - DD 20231019',
      'wfwi Custom CC Fields 20231019', 
      'wfwi Custom DD Fields 20231019', 
    ];
