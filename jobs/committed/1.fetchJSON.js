alterState(state => {
  return list('/')(state).then(state => {
    const partialFilenames = [
      'wfwi Card Master 24062022',
      'wfwi Direct Debits 24062022',
      'wfwi Transactions - Cards 24062022',
      'wfwi Transactions - DD 24062022',
      'wfwi Custom CC Fields 24062022',
      'wfwi Custom DD Fields 24062022',
    ];
