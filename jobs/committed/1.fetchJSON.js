alterState(state => {
  return list('/')(state).then(state => {
    const partialFilenames = [
      'wfwi Card Master 20230421',
      'wfwi Direct Debits 20230421',
      'wfwi Transactions - Cards 20230421',
      'wfwi Transactions - DD 20230421',
      'wfwi Custom DD Fields 20230421',
      'wfwi Custom CC Fields 20230421',
    ];
