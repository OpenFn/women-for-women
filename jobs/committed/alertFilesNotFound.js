fn(state => {
  ...
  const email = {
    ...
    html: `Dear admins, <br/><br/> Committed Giving file exports for WFWI may have NOT been uploaded to the SFTP server for date ${missingDate}. The missing files are: <b>${missingFiles.join(
      ', '
    )}</b>.
   Please review the sftp server and upload any missing CSV exports. Contact OpenFn at <a href='mailto:support@openfn.org'>support@openfn.org</a> with any questions about this alert.`,
  };
